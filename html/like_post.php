...
//좋아요 중복을 방지하기 위해
//사용자가 이미 게시글에 좋아요를 한 경우 exit
if($didUserLike) {
    exit();
}

//좋아요 기록 테이블 board_like에 새로운 row 삽입
$sqlInsert = "insert into board_like(post_id, user_email) values('$bNo', '$email')";
